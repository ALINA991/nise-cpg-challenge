...
{
int n = 20; // num of iterations in update 
//double x0 = t-ts;
//double xf = t;
double h; 
//h = (xf-x0)/(double)n;
...
{ // RECURRENCE 
  ...
  // four equations per neuron  -> will be summed up & averaged
  ...
  k = 1/6.0 * (k1 + 2*k2 + 2*k3 + k4); // get update term to sum with previous y 
...
// ////// check how to change intrinsic caract of each neuron seperatly 
