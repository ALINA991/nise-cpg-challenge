...
Pattern DOUBLEOSC = {4.6,1.5,0.05,1};
// Decrease tao by half could lead to the same effects:
//
...
setup_RS_neurons(&rs_neuron[1],DOUBLEOSC,"Double Oscillation");
}
...
inject_current(myTime, &rs_neuron[0], 2000, 2050);
inject_current(myTime, &rs_neuron[1], 2000, 2050);
